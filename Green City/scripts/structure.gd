...
@export var income_upgrade_ratio: float = 0.15 # 10% increase per level
@export var income_upgrade_cost_base: float = 10000.0 # Base cost for income upgrade
@export var income_upgrade_cost_multiplier: float = 1.5 # Cost multiplier per level

# Upgrade path 2: Reduce pollution
@export var pollution_upgrade_level: int = 0
@export var max_pollution_upgrade_level: int = 3
@export var pollution_reduction_ratio: float = 0.15 # 10% reduction per level
@export var pollution_upgrade_cost_base: float = 10000.0 # Base cost for pollution upgrade
@export var pollution_upgrade_cost_multiplier: float = 1.5 # Cost multiplier per level
